...
En reconversion vers les métiers de l'IT, je me spécialise dans les domaines **réseau, infrastructure et administration système**.  
Ma progression passe par la pratique : labs GNS3, scripts d'automatisation PowerShell et documentation technique structurée.
...
📁 [`lab-gns3-security`](https://github.com/CedricRibier/lab-gns3-security)
...
📁 [`powershell-scripts`](https://github.com/CedricRibier/powershell-scripts)
